...
## Backend Setup
- The backend consists of multiple microservices managed via Docker Compose.
- Ensure Docker is installed and running on your system.
- To start all backend services, navigate to the `admission-jockey-backend` directory.
- Run the command: `docker-compose up`
- This will start all microservices, databases, and dependencies.
- The API Gateway will be accessible on port 3000 by default.
