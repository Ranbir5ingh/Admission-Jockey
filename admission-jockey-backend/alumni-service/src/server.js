...
const logger = winston.createLogger({
  ...
  defaultMeta: { service: 'alumni-service' },
  transports: [
...
const SERVICE_NAME = 'alumni-service';
const SERVICE_ID = 'alumni-service-' + PORT;
const SERVICE_ADDRESS = process.env.SERVICE_ADDRESS || 'localhost';

const server = app.listen(PORT, () => {
  logger.info(`alumni-service running on port ${PORT}`);
